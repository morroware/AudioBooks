/**
 * main.js - Main application entry point for LibriVox Audiobooks
 */
...
async function initializePlayerPage() {
    ...
    if (!identifier) {
        showPlayerInitError('No audiobook ID provided. Please select an audiobook from the library.');
        return;
    }
    ...
    try {
        ...
        if (!success) {
            showPlayerInitError('Failed to load audiobook. The recording may be unavailable.');
            return;
        }
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded - initializing LibriVox Audiobooks application');
